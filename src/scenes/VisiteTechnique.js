...
const VisiteTechnique = ()=>{
  ...
  return(
    ...
    <HeaderComponent label='Ajouter une service' style={{paddingBottom: 15,paddingTop: 15, backgroundColor:'#C0C0C0'}}/>
    <ScrollView  >
       <Item style={{paddingBottom: 15,paddingTop: 15}}>
        ...
        <Item style={styles.formItems}>
          ...
          <Input placeholder="Visite Technique" style={{marginLeft: 127}} />
        </Item>
